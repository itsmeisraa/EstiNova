...
🏗️ Architecture
🔁 System Flow
User sends a message via chatbot
Frontend sends request via webhook
User context is retrieved (role, group, etc.)
Main AI Agent routes request
Specialized agent processes it
...
🧠 Vector search
✍️ Context-aware answer generation
🛠️ Tech Stack
...
🔐 HTTPS encryption
🛡️ Anti-social engineering design
⚙️ Features
✅ Student Features
View timetable
...
Publish announcements
📈 Performance
⏱️ Simple queries: ~15s
⏱️ Complex queries: up to 90s
